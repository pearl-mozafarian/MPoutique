<article class="main-content index-main-content">
    ...
    <section class="section-main-content-para">
        <h1 class="section-title" id="index-welcome-para-title">Welcome to MBoutique!</h1>
        ...
        <h1 class="section-title" id="index-we-love-para-title">We Love Macacrons!</h1>
    ...
    <section class="section-main-content-samples">
        <h1 class="section-title" id="index-samples-title">Find the flavor that you like.  Try a sample everyday.</h1>
        <div class="wrapper">
            <div class="day">
